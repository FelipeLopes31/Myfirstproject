...
public class MyfirstprojectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p2 = new Product(2L, "Devotional Joy of Dawn", 53.60, cat2);
		Product p3 = new Product(3L, "PS5", 4999.99, cat1);
		Product p4 = new Product(4L, "Twelve days to update your life", 32.49, cat2);
